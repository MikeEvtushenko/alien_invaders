...
class AlienInvasion:
    ...
    def _check_keydown_events(self, event):
        if event.key == pygame.K_RIGHT:
            ...
            # Корабль двигается налево
            self.ship.moving_left = True
        elif event.key == pygame.K_q:  # выключаем игру по нажатию q
            sys.exit()
    ...
    def _create_fleet(self):
        ...
        """Опрделяет количество рядов, помещающихся на экране"""
    ...
    def _change_fleet_direction(self):
        """Снижает весь флот и меняет его направление"""
        for alien in self.aliens.sprites():
